...
const LabYatharth = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <div className="relative bg-gradient-to-br from-purple-600 via-purple-700 to-indigo-700 text-white py-24 overflow-hidden">
        {/* DNA Helix Animation */}
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-20 left-20 w-2 h-96 bg-white rounded-full transform rotate-45 animate-spin-slow"></div>
          <div className="absolute top-20 right-20 w-2 h-96 bg-purple-300 rounded-full transform -rotate-45 animate-spin-reverse"></div>
        </div>
        ...
        <div className="relative container mx-auto px-4 text-center">
          <div className="max-w-5xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              Lab Yatharth
              <span className="block text-3xl md:text-5xl text-purple-200 mt-2">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-10 max-w-3xl mx-auto">
              <div className="text-center">
                ...
                <div className="text-sm text-purple-200">Blood Tests</div>
              </div>
              <div className="text-center">
                <div className="text-2xl mb-2">🦠</div>
                <div className="text-sm text-purple-200">Microbiology</div>
              </div>
              <div className="text-center">
                <div className="text-2xl mb-2">🔬</div>
                <div className="text-sm text-purple-200">Histopathology</div>
              </div>
              <div className="text-center">
                <div className="text-2xl mb-2">⚡</div>
                <div className="text-sm text-purple-200">Quick Results</div>
              </div>
            </div>
            
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-white text-purple-600 hover:bg-gray-100 font-bold py-4 px-8 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                Book Lab Test
              </button>
              <button className="border-2 border-white text-white hover:bg-white hover:text-purple-600 font-bold py-4 px-8 rounded-xl transition-all duration-300">
                View Test Menu
              </button>
            </div>
          </div>
