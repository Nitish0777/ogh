        ...
        <div className="container mx-auto px-6">
          ...
          <div className="text-center max-w-6xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-green-50 mb-12 max-w-4xl mx-auto leading-relaxed">
              Accredited Health & Occupational Medical Services
            </p>
            
            {/* Stats Cards */}
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
              <div className="bg-white/15 backdrop-blur-sm rounded-xl p-6 hover:bg-white/20 transition-all duration-300">
                <div className="text-3xl font-bold text-white mb-2">DISH</div>
                <div className="text-green-100 text-sm font-medium">Certified</div>
              </div>
              
              <div className="bg-white/15 backdrop-blur-sm rounded-xl p-6 hover:bg-white/20 transition-all duration-300">
                <div className="text-3xl font-bold text-white mb-2">DGI</div>
                <div className="text-green-100 text-sm font-medium">Approved</div>
              </div>
              
              <div className="bg-white/15 backdrop-blur-sm rounded-xl p-6 hover:bg-white/20 transition-all duration-300">
                <div className="text-3xl font-bold text-white mb-2">JNPT</div>
                <div className="text-green-100 text-sm font-medium">Recognized</div>
              </div>
              
              <div className="bg-white/15 backdrop-blur-sm rounded-xl p-6 hover:bg-white/20 transition-all duration-300">
                <div className="text-3xl font-bold text-white mb-2">OGUK</div>
                <div className="text-green-100 text-sm font-medium">Certified</div>
              </div>
            </div>
          </div>
